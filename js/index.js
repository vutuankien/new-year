...
document.addEventListener('DOMContentLoaded', function () {
  ...
  audio.play().catch(function () {
    ...
    // For example, you can show a play button and let the user start the audio manually
  });
});
...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3||Chúc|Huyền|Năm|Mới|Hạnh|Phúc|Happy|New|Year|2024|❤|');
    }
